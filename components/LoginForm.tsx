...
// Only ever navigates within this app — guards against an open redirect via
// a crafted ?redirect= value (e.g. "//evil.com" or "https://evil.com").
    ...
    <main className="flex min-h-screen flex-1 flex-col items-center justify-center bg-ivory px-6 py-20">
      <div className="w-full max-w-sm">
        <div className="mb-10 text-center">
          ...
          <h1 className="mt-2 font-heading text-3xl text-espresso">Log In</h1>
        </div>
        ...
        <p className="mt-8 text-center font-sans text-sm text-charcoal/70">
          New here?{" "}
          <Link href="/signup" className="text-bronze underline underline-offset-4">
            Create an account
          </Link>
        </p>
      </div>
